import ZKLib.JoltConstraint.Instruction.Basic

/-!
  # Add instruction in Jolt
-/
...
structure AddInstruction where
  firstOperand : UInt64
  secondOperand : UInt64

instance : Instruction F AddInstruction where
